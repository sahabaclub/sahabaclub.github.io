...
(function () {
  ...
  function loadEventsFromDatabase() {
    var client = null;
    return import("./lib/supabase-client.js?v=9eac91b2c9").then(function (mod) {
      client = mod.supabase;
  ...
  function loadSocial() {
    return import("./lib/event-social.js?v=9eac91b2c9").then(function (mod) {
      social = mod;
  ...
  function refreshAccess() {
    return import("./lib/supabase-client.js?v=9eac91b2c9").then(function (client) {
      if (!client.isConfigured) return null;
      return import("./lib/tier-gate.js?v=9eac91b2c9").then(function (m) { return m.getAccessLevel(); });
    }).then(function (level) {
  ...
  function loadRegisterPrompt() {
    ...
    if (!registerPromptPromise) {
      registerPromptPromise = import("./lib/register-prompt.js?v=9eac91b2c9");
    }
