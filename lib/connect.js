...
import { supabase } from "./supabase-client.js?v=1696b16761";
  ...
  const ranked = await pageAll(
    (from, to) =>
      supabase
        ...
        // twice and drops others. `listDirectory` has the same weakness on
        // `member_since` and always has; here it would have been the norm
