...
import { supabase } from "../../lib/supabase-client.js?v=4bf9f935fb";
import { describeSpec, rejectionReason, inspect, uploadEventImage } from "../../lib/event-images.js?v=4bf9f935fb";
import {
  requireStaff, renderShell, escapeHtml, formatDate, showMessage, clearMessage,
} from "../../lib/admin-guard.js?v=4bf9f935fb";
