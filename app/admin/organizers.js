...
import { supabase } from "../../lib/supabase-client.js?v=921779d252";
import { describeSpec, rejectionReason, inspect, uploadEventImage } from "../../lib/event-images.js?v=921779d252";
import {
  requireStaff, renderShell, escapeHtml, formatDate, showMessage, clearMessage,
} from "../../lib/admin-guard.js?v=921779d252";
