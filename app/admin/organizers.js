...
import { supabase } from "../../lib/supabase-client.js?v=a05d5717f7";
import { describeSpec, rejectionReason, inspect, uploadEventImage } from "../../lib/event-images.js?v=a05d5717f7";
import {
  requireStaff, renderShell, escapeHtml, formatDate, showMessage, clearMessage,
} from "../../lib/admin-guard.js?v=a05d5717f7";
