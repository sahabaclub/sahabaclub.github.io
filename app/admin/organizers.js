...
import { supabase } from "../../lib/supabase-client.js?v=90970f2d1d";
import { describeSpec, rejectionReason, inspect, uploadEventImage } from "../../lib/event-images.js?v=90970f2d1d";
import {
  requireStaff, renderShell, escapeHtml, formatDate, showMessage, clearMessage,
} from "../../lib/admin-guard.js?v=90970f2d1d";
