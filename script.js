...
(function () {
  ...
  import("./lib/supabase-client.js?v=162f478dae").then(function (mod) {
...
(function () {
  ...
  import("./lib/supabase-client.js?v=162f478dae")
    ...
    .then(function (session) {
      ...
      return import("./lib/notifications.js?v=162f478dae").then(function (mod) {
        notifications = mod;
        return mod.refreshNavBadges().then(function () {
          ...
          return import("./lib/push.js?v=162f478dae").then(function (push) {
            push.reconcile();
