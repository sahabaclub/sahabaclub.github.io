...
(function () {
  ...
  import("./lib/supabase-client.js?v=ab980d4e4c").then(function (mod) {
...
(function () {
  ...
  import("./lib/supabase-client.js?v=ab980d4e4c")
    ...
    .then(function (session) {
      ...
      return import("./lib/notifications.js?v=ab980d4e4c").then(function (mod) {
        notifications = mod;
        return mod.refreshNavBadges().then(function () {
          ...
          return import("./lib/push.js?v=ab980d4e4c").then(function (push) {
            push.reconcile();
