...
(function () {
  ...
  import("./lib/supabase-client.js?v=16538a1b6f").then(function (mod) {
...
(function () {
  ...
  import("./lib/supabase-client.js?v=16538a1b6f")
    ...
    .then(function (session) {
      ...
      return import("./lib/notifications.js?v=16538a1b6f").then(function (mod) {
        notifications = mod;
        return mod.refreshNavBadges().then(function () {
          ...
          return import("./lib/push.js?v=16538a1b6f").then(function (push) {
            push.reconcile();
