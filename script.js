...
(function () {
  ...
  import("./lib/supabase-client.js?v=7748bdbeaa").then(function (mod) {
...
(function () {
  ...
  import("./lib/supabase-client.js?v=7748bdbeaa")
    ...
    .then(function (session) {
      ...
      return import("./lib/notifications.js?v=7748bdbeaa").then(function (mod) {
        notifications = mod;
        return mod.refreshNavBadges().then(function () {
          ...
          return import("./lib/push.js?v=7748bdbeaa").then(function (push) {
            push.reconcile();
