...
(function () {
  ...
  import("./lib/supabase-client.js?v=f781ae2494").then(function (mod) {
...
(function () {
  ...
  import("./lib/supabase-client.js?v=f781ae2494")
    ...
    .then(function (session) {
      ...
      return import("./lib/notifications.js?v=f781ae2494").then(function (mod) {
        notifications = mod;
        return mod.refreshNavBadges().then(function () {
          ...
          return import("./lib/push.js?v=f781ae2494").then(function (push) {
            push.reconcile();
