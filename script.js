...
(function () {
  ...
  import("./lib/supabase-client.js?v=d684ef7c0d").then(function (mod) {
...
(function () {
  ...
  import("./lib/supabase-client.js?v=d684ef7c0d")
    ...
    .then(function (session) {
      ...
      return import("./lib/notifications.js?v=d684ef7c0d").then(function (mod) {
        notifications = mod;
        return mod.refreshNavBadges().then(function () {
          ...
          return import("./lib/push.js?v=d684ef7c0d").then(function (push) {
            push.reconcile();
