...
(function () {
  ...
  import("./lib/supabase-client.js?v=239a0c17c2").then(function (mod) {
...
(function () {
  ...
  import("./lib/supabase-client.js?v=239a0c17c2")
    ...
    .then(function (session) {
      ...
      return import("./lib/notifications.js?v=239a0c17c2").then(function (mod) {
        notifications = mod;
        return mod.refreshNavBadges().then(function () {
          ...
          return import("./lib/push.js?v=239a0c17c2").then(function (push) {
            push.reconcile();
