...
(function () {
  ...
  import("./lib/supabase-client.js?v=2bee541930").then(function (mod) {
...
(function () {
  ...
  import("./lib/supabase-client.js?v=2bee541930")
    ...
    .then(function (session) {
      ...
      return import("./lib/notifications.js?v=2bee541930").then(function (mod) {
        notifications = mod;
        return mod.refreshNavBadges().then(function () {
          ...
          return import("./lib/push.js?v=2bee541930").then(function (push) {
            push.reconcile();
