...
(function () {
  ...
  import("./lib/supabase-client.js?v=8917e84e6a").then(function (mod) {
...
(function () {
  ...
  import("./lib/supabase-client.js?v=8917e84e6a")
    ...
    .then(function (session) {
      ...
      return import("./lib/notifications.js?v=8917e84e6a").then(function (mod) {
        notifications = mod;
        return mod.refreshNavBadges().then(function () {
          ...
          return import("./lib/push.js?v=8917e84e6a").then(function (push) {
            push.reconcile();
