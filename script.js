...
(function () {
  ...
  import("./lib/supabase-client.js?v=bf67066856").then(function (mod) {
...
(function () {
  ...
  import("./lib/supabase-client.js?v=bf67066856")
    ...
    .then(function (session) {
      ...
      return import("./lib/notifications.js?v=bf67066856").then(function (mod) {
        notifications = mod;
        return mod.refreshNavBadges().then(function () {
          ...
          return import("./lib/push.js?v=bf67066856").then(function (push) {
            push.reconcile();
