...
(function () {
  ...
  import("./lib/supabase-client.js?v=95a6e12add").then(function (mod) {
...
(function () {
  ...
  import("./lib/supabase-client.js?v=95a6e12add")
    ...
    .then(function (session) {
      ...
      return import("./lib/notifications.js?v=95a6e12add").then(function (mod) {
        notifications = mod;
        return mod.refreshNavBadges().then(function () {
          ...
          return import("./lib/push.js?v=95a6e12add").then(function (push) {
            push.reconcile();
