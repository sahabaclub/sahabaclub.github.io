...
(function () {
  ...
  import("./lib/supabase-client.js?v=daa960a3f6").then(function (mod) {
...
(function () {
  ...
  import("./lib/supabase-client.js?v=daa960a3f6")
    ...
    .then(function (session) {
      ...
      return import("./lib/notifications.js?v=daa960a3f6").then(function (mod) {
        notifications = mod;
        return mod.refreshNavBadges().then(function () {
          ...
          return import("./lib/push.js?v=daa960a3f6").then(function (push) {
            push.reconcile();
