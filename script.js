...
(function () {
  ...
  import("./lib/supabase-client.js?v=90970f2d1d").then(function (mod) {
...
(function () {
  ...
  import("./lib/supabase-client.js?v=90970f2d1d")
    ...
    .then(function (session) {
      ...
      return import("./lib/notifications.js?v=90970f2d1d").then(function (mod) {
        notifications = mod;
        return mod.refreshNavBadges().then(function () {
          ...
          return import("./lib/push.js?v=90970f2d1d").then(function (push) {
            push.reconcile();
