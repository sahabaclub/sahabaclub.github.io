...
(function () {
  ...
  import("./lib/supabase-client.js?v=38ecac0a41").then(function (mod) {
...
(function () {
  ...
  import("./lib/supabase-client.js?v=38ecac0a41")
    ...
    .then(function (session) {
      ...
      return import("./lib/notifications.js?v=38ecac0a41").then(function (mod) {
        notifications = mod;
        return mod.refreshNavBadges().then(function () {
          ...
          return import("./lib/push.js?v=38ecac0a41").then(function (push) {
            push.reconcile();
