...
(function () {
  ...
  import("./lib/supabase-client.js?v=184409188e").then(function (mod) {
...
(function () {
  ...
  import("./lib/supabase-client.js?v=184409188e")
    ...
    .then(function (session) {
      ...
      return import("./lib/notifications.js?v=184409188e").then(function (mod) {
        notifications = mod;
        return mod.refreshNavBadges().then(function () {
          ...
          return import("./lib/push.js?v=184409188e").then(function (push) {
            push.reconcile();
