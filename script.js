...
(function () {
  ...
  import("./lib/supabase-client.js?v=4bf9f935fb").then(function (mod) {
...
(function () {
  ...
  import("./lib/supabase-client.js?v=4bf9f935fb")
    ...
    .then(function (session) {
      ...
      return import("./lib/notifications.js?v=4bf9f935fb").then(function (mod) {
        notifications = mod;
        return mod.refreshNavBadges().then(function () {
          ...
          return import("./lib/push.js?v=4bf9f935fb").then(function (push) {
            push.reconcile();
