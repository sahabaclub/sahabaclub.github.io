...
(function () {
  ...
  import("./lib/supabase-client.js?v=aba5b41535").then(function (mod) {
...
(function () {
  ...
  import("./lib/supabase-client.js?v=aba5b41535")
    ...
    .then(function (session) {
      ...
      return import("./lib/notifications.js?v=aba5b41535").then(function (mod) {
        notifications = mod;
        return mod.refreshNavBadges().then(function () {
          ...
          return import("./lib/push.js?v=aba5b41535").then(function (push) {
            push.reconcile();
